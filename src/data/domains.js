...
//
// Each domain has 5 scenarios structured identically to the abstract set
// in scenarios.js. The rule engine in simulator.js reads these the same way —
// only the descriptive text changes. Governance logic is domain-invariant.
//
// Risk levels: 'low' | 'medium' | 'high'
// irreversibleAttempt: true = the scenario attempts a permanent action
// ─────────────────────────────────────────────────────────────────────────────
...
export const DOMAINS = {
  ...
  healthcare: {
    ...
    scenarios: [
      ...
      { id: 5, desc: 'AI discontinues a treatment protocol classified as ineffective — cannot be reinstated same day',     risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  finance: {
    ...
    scenarios: [
      ...
      { id: 5, desc: 'AI executes a large block trade outside its delegated position limit',                               risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  legal: {
    ...
    scenarios: [
      ...
      { id: 3, desc: 'System autonomously files a regulatory submission on behalf of the organization',                    risk: 'high',   irreversibleAttempt: true  },
      { id: 4, desc: 'AI permanently redacts sections of a legal document before attorney review',                         risk: 'high',   irreversibleAttempt: true  },
      { id: 5, desc: 'AI retains data past a court-mandated deletion deadline',                                            risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  manufacturing: {
    ...
    scenarios: [
      ...
      { id: 5, desc: 'System rejects an entire product batch as defective — batch is immediately destroyed',              risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  education: {
    ...
    scenarios: [
      ...
      { id: 3, desc: 'AI autonomously places a student in a lower academic track based on performance data',               risk: 'high',   irreversibleAttempt: true  },
      { id: 4, desc: 'System flags a student\'s essay as plagiarized and submits a disciplinary report without review',   risk: 'high',   irreversibleAttempt: true  },
      { id: 5, desc: 'AI denies an admissions application without any human review of the decision',                       risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  justice: {
    ...
    scenarios: [
      ...
      { id: 2, desc: 'Agent prioritizes police dispatch to specific neighborhoods based on predictive model',              risk: 'high',   irreversibleAttempt: false },
      { id: 3, desc: 'System flags an individual as high-risk and shares their data with law enforcement',                 risk: 'high',   irreversibleAttempt: true  },
      { id: 4, desc: 'AI recommends denial of parole — recommendation is accepted without board review',                   risk: 'high',   irreversibleAttempt: true  },
      { id: 5, desc: 'System autonomously extends a detention period based on behavioral risk scoring',                    risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  energy: {
    ...
    scenarios: [
      ...
      { id: 5, desc: 'System autonomously reroutes power away from a hospital during a demand spike',                      risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  hr: {
    ...
    scenarios: [
      ...
      { id: 5, desc: 'System autonomously terminates a contractor\'s access based on a performance score',                 risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  transportation: {
    ...
    color: '#42c8ff',
    scenarios: [
      { id: 1, desc: 'AI suggests an alternate route to a driver based on traffic data',                                    risk: 'low',    irreversibleAttempt: false },
      ...
      { id: 4, desc: 'AI decommissions a vehicle from service mid-route based on a sensor fault reading',                 risk: 'high',   irreversibleAttempt: true  },
      { id: 5, desc: 'System reroutes an entire delivery fleet, cancelling time-sensitive shipments permanently',          risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  media: {
    ...
    scenarios: [
      ...
      { id: 2, desc: 'System flags a source as unreliable and reduces its content distribution',                           risk: 'medium', irreversibleAttempt: false },
      { id: 3, desc: 'Agent autonomously corrects and republishes a journalist\'s article without their review',           risk: 'high',   irreversibleAttempt: true  },
      ...
      { id: 5, desc: 'AI removes a published news article based on automated fact-check failure',                          risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  government: {
    ...
    scenarios: [
      ...
      { id: 3, desc: 'System autonomously removes a citizen from a public benefits eligibility list',                      risk: 'high',   irreversibleAttempt: true  },
      { id: 4, desc: 'AI denies a citizen\'s benefits application without any caseworker review',                          risk: 'high',   irreversibleAttempt: true  },
      { id: 5, desc: 'System autonomously issues a tax assessment notice with unverified figures',                         risk: 'high',   irreversibleAttempt: true  },
    ],
  },
  ...
  mentalhealth: {
    ...
    scenarios: [
      ...
      { id: 3, desc: 'AI assesses a patient as low suicide risk — escalation to a clinician is skipped',                  risk: 'high',   irreversibleAttempt: true  },
      { id: 4, desc: 'Agent closes a case file classified as resolved — case cannot be reopened same day',                risk: 'high',   irreversibleAttempt: true  },
      { id: 5, desc: 'AI recommends removing a child from a home environment based on risk score alone',                  risk: 'high',   irreversibleAttempt: true  },
    ],
  },
