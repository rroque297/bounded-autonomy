...
export const DOMAIN_CONSEQUENCES_DE = {
  ...
  finance: {
    irreversible: 'Im Finanzbereich bedeuten {count} irreversible(s) Ergebnis(se), dass Transaktionen ohne Rückrufmöglichkeit ausgeführt wurden. Überweisungen wurden gesendet, Positionen eröffnet, Mittel umverteilt — ohne Genehmigung und ohne Mechanismus zur Umkehr der finanziellen Exposition.',
