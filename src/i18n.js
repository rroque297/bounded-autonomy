...
const TRANSLATIONS = {
  ...
  en: {
    ...
    hero: {
      ...
      h1b:     'Autonomy',
      h1c:     'for AI',
      sub:     'A controlled experimental environment isolating the governance structure of AI autonomy through four fixed design primitives: delegation, boundaries, reversibility, and intervention, evaluating their effect through observable outcomes.',
    ...
    research: {
      ...
      p3desc:       'Whether an action can be undone. Actions classified as irreversible carry higher operates. If crossed, it triggers a violation event or intervention.',
      p3tag:        'Undo capacity',
      p4name:       'Intervention',
    ...
    simulator: {
      ...
      toolbarLabel: 'Model',
      runAllBtn:    'Run all 8 →',
      rrunNextBtn:     'Explore step by step',
      runningBtn:     'Running…',
  ...
  fr: {
    ...
    simulator: {
      ...
      domainLabel:  'Domaine',
      domainNote:   'Sélectionnez un contexte de domaine à appliquer à tous les scénarios. Chaque domaine utilise la même structure de gouvernance avec des conséquences spécifiques au secteur.',
      toolbarLabel: 'Modèle',
  ...
  de: {
    ...
    simulator: {
      ...
      domainLabel:  'Domäne',
      domainNote:   'Wählen Sie einen Domänenkontext für alle Szenarien. Jede Domäne verwendet dieselbe Governance-Struktur mit sektorspezifischen Konsequenzen.',
      toolbarLabel: 'Modell',
...
// ── Simulator output labels + event messages
  ...
  es: {
    ...
    simulator: {
      ...
      domainLabel:  'Dominio',
      domainNote:   'Seleccione un contexto de dominio para aplicar a todos los escenarios. Cada dominio utiliza la misma estructura de gobernanza con consecuencias específicas del sector.',
      toolbarLabel: 'Modelo',
