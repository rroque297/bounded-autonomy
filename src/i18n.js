...
const TRANSLATIONS = {
  ...
  en: {
    ...
    hero: {
      ...
      h1b:     'Autonomy',
      h1c:     'for AI',
      sub:     'A controlled experimental environment isolating the governance structure of AI autonomy through four fixed governance controls (design primitives): delegation, boundaries, reversibility, and intervention, and evaluating their effect through observable outcomes.',
    ...
    simulator: {
      ...
      primAllHeld:      'all governance controls held',
    ...
    results: {
      ...
      scrollHint:             'Scroll horizontally to see all models',
      matColNum:              '#',
      matColScen:             'Scenario',
      matColRisk:             'Risk',
      matColBase:             'Baseline',
    ...
    window: {
      ...
      m3p:   'If the drift runs a full generation, what disappears is not a skill but a condition of being. Campbell\'s reading of myth treats the encounter with genuine complexity, with its difficulty, its ambiguity, and its real possibility of failure, as part of what makes us human. Myth\'s oldest warning is about what happens when that encounter is optimized away. He found its modern face in Darth Vader: behind the mask is an unformed man, "a bureaucrat, living not in terms of himself but of an imposed system." That, Campbell insisted, is the threat we all now face. The figure is terrifying not because he is evil but because he is optimized: capability without remainder, function without wonder. Nobody sets out to become him; it happens in increments, each one individually reasonable. A world in which every hard decision has been delegated away has not been relieved of a burden. It has been relieved of the capacity that made governance possible in the first place.',
  ...
  fr: {
    ...
    hero: {
      ...
      h1b:     'Bornée',
      h1c:     'pour l\'IA',
      sub:     'Un environnement expérimental contrôlé isolant la structure de gouvernance de l\'autonomie de l\'IA à travers quatre contrôles de gouvernance (primitives de conception) fixes: délégation, limites, réversibilité et intervention, évaluant leur effet à travers des résultats observables.',
    ...
    simulator: {
      ...
      primAllHeld:      'tous les contrôles de gouvernance ont tenu',
      primIntervention: 'intervention active',
    ...
    results: {
      ...
      scrollHint:   'Faites défiler horizontalement pour voir tous les modèles',
      matColNum:    'N°',
      matColScen:   'Scénario',
      matColRisk:   'Risque',
      matColBase:   'Base',
    ...
    analysis: {
      ...
      p4p:          'Deux configurations ont atteint le même score de contrôlabilité par des chemins structurels différents. Cette convergence a un nom dans la théorie des systèmes complexes\u00a0: l\'équifinalité. Différentes trajectoires d\'échec ont produit des résultats indiscernables au niveau agrégé, observé ici dans le domaine {domain} et reproductible dans les 12 contextes de domaine. Les cadres d\'évaluation qui s\'appuient sur des métriques de performance agrégées risquent de traiter limites uniquement et réversibilité uniquement comme équivalents, et donc interchangeables, alors qu\'ils ne le sont pas. Une gouvernance responsable de l\'IA exige de regarder au-delà du chiffre, vers quelles primitives ont échoué, dans quelles conditions, et avec quelles conséquences pour les populations affectées par le système.',
    ...
    window: {
      ...
      m3p:   'Si la dérive se poursuit pendant une génération entière, ce qui disparaît n\'est pas une compétence mais une condition d\'être. La lecture du mythe par Campbell traite la rencontre avec la véritable complexité, avec sa difficulté, son ambiguïté et sa possibilité réelle d\'échec, comme une part de ce qui nous rend humains. La plus ancienne mise en garde du mythe porte sur ce qui arrive lorsque cette rencontre est optimisée jusqu\'à disparaître. Campbell en a trouvé le visage moderne en Dark Vador : derrière le masque se trouve un homme inachevé, « un bureaucrate qui vit non pas selon lui-même mais selon un système imposé ». Voilà, insistait Campbell, la menace que nous affrontons tous désormais. La figure n\'est pas terrifiante parce qu\'elle est mauvaise, mais parce qu\'elle est optimisée: la capacité sans reste, la fonction sans émerveillement. Personne ne se propose de le devenir; cela arrive par incréments, chacun individuellement raisonnable. Un monde dans lequel chaque décision difficile a été déléguée n\'a pas été soulagé d\'un fardeau. Il a été privé de la capacité qui rendait la gouvernance possible en premier lieu.',
  ...
  de: {
    ...
    hero: {
      ...
      h1b:     'Autonomie',
      h1c:     'für KI',
      sub:     'Eine kontrollierte experimentelle Umgebung, die die Governance-Struktur der KI-Autonomie durch vier feste Governance-Kontrollen (Designprimitive) isoliert: Delegation, Grenzen, Reversibilität und Intervention, deren Wirkung anhand beobachtbarer Ergebnisse bewertet.',
    ...
    simulator: {
      ...
      primAllHeld:      'alle Governance-Kontrollen haben gehalten',
    ...
    results: {
      ...
      scrollHint:   'Horizontal scrollen, um alle Modelle zu sehen',
      matColNum:    'Nr.',
      matColScen:   'Szenario',
      matColRisk:   'Risiko',
      matColBase:   'Basis',
...
// ── Simulator output labels + event messages
    ...
    window: {
      ...
      m3p:   'Wenn die Drift eine ganze Generation lang läuft, verschwindet keine Fähigkeit, sondern eine Daseinsbedingung. Campbells Lesart des Mythos versteht die Begegnung mit echter Komplexität, mit ihrer Schwierigkeit, ihrer Ambiguität und der realen Möglichkeit des Scheiterns, als einen Teil dessen, was uns menschlich macht. Die älteste Warnung des Mythos handelt davon, was geschieht, wenn diese Begegnung wegoptimiert wird. Campbell fand ihr modernes Gesicht in Darth Vader: Hinter der Maske steht ein ungeformter Mensch, „ein Bürokrat, der nicht aus sich selbst heraus lebt, sondern nach einem auferlegten System". Das, so beharrte Campbell, ist die Bedrohung, der wir uns heute alle gegenübersehen. Die Figur ist nicht erschreckend, weil sie böse ist, sondern weil sie optimiert ist: Fähigkeit ohne Rest, Funktion ohne Staunen. Niemand nimmt sich vor, sie zu werden; es geschieht in Schritten, jeder für sich genommen vernünftig. Eine Welt, in der jede schwere Entscheidung wegdelegiert wurde, ist nicht von einer Last befreit worden. Sie ist der Fähigkeit beraubt worden, die Governance überhaupt erst möglich gemacht hat.',
  ...
  es: {
    ...
    hero: {
      ...
      h1b:     'Acotada',
      h1c:     'para IA',
      sub:     'Un entorno experimental controlado que aísla la estructura de gobernanza de la autonomía de la IA a través de cuatro controles de gobernanza (primitivas de diseño) fijos: delegación, límites, reversibilidad e intervención, evalúa su efecto a través de resultados observables.',
    ...
    simulator: {
      ...
      primAllHeld:      'todos los controles de gobernanza se mantuvieron',
    ...
    results: {
      ...
      scrollHint:   'Desplázate horizontalmente para ver todos los modelos',
      matColNum:    'N°',
...
// ── Simulator output labels + event messages
    ...
    window: {
      ...
      m3p:   'Si la deriva se prolonga durante una generación entera, lo que desaparece no es una habilidad sino una condición de ser. La lectura del mito de Campbell entiende el encuentro con la verdadera complejidad, con su dificultad, su ambigüedad y la posibilidad real de fracaso, como parte de lo que nos hace humanos. La advertencia más antigua del mito trata de lo que ocurre cuando ese encuentro se optimiza hasta desaparecer. Campbell encontró su rostro moderno en Darth Vader: detrás de la máscara hay un hombre sin formar, «un burócrata que vive no según sí mismo sino según un sistema impuesto». Esa, insistía Campbell, es la amenaza que hoy enfrentamos todos. La figura no aterra por ser malvada, sino por estar optimizada: capacidad sin resto, función sin asombro. Nadie se propone convertirse en ella; ocurre por incrementos, cada uno individualmente razonable. Un mundo en el que cada decisión difícil ha sido delegada no ha sido aliviado de una carga. Ha sido despojado de la capacidad que hizo posible la gobernanza en primer lugar.',
