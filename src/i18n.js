...
const TRANSLATIONS = {
  ...
  en: {
    ...
    research: {
      ...
      p5desc:       'The governance frontier this framework identifies but cannot yet operationalize. Contestability (the capacity for affected parties to see, challenge, or reject autonomous decisions) marks the boundary of what bounded autonomy can currently guarantee. The reason this frontier remains uncrossed is a co-production deficit: the primitives were specified without the participation of those governed by the systems they constrain. Contestability requires their presence in the design process, not only in the outcome.',
      p5tag:        'Frontier',
    },
